...
<div class="w-full h-full flex place-items-center justify-center">
	{#if ready}
		<div class="flex flex-row flex-wrap gap-4">
			...
			<a
				class="btn btn-md md:btn-lg btn-primary animate-scale rounded-full"
				href="/projects"
				in:fly={{
					delay: 2850,
					duration: 300,
			...
			>
				<svg
					class="fill-primary-content w-6 h-6 md:w-8 md:h-8"
					viewBox="0 0 24 24"
				>
...
<style>
	.square-shadow {
		...
		box-shadow: 0.5rem 0.5rem 0 1px hsl(var(--b3));
	}
